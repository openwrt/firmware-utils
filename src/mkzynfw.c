...
:x
	 ...
	 */
	RTL_OTTO_BOARD("GS1920-24-v1",   "Zyxel GS1920-24",     MID(20994), 16, 0xB0000),  /* AAOB */
	RTL_OTTO_BOARD("GS1920-24HP-v1", "Zyxel GS1920-24HP",   MID(21250), 16, 0xB0000),  /* AAOC */
	RTL_OTTO_BOARD("GS1920-48-v1",   "Zyxel GS1920-48",     MID(20482), 16, 0xB0000),  /* AANZ */
	RTL_OTTO_BOARD("GS1920-48HP-v1", "Zyxel GS1920-48HP",   MID(20738), 16, 0xB0000),  /* AAOA */
	RTL_OTTO_BOARD("GS1920-8HP-v2",  "Zyxel GS1920-8HPv2",  MID(27138), 32, 0x200000), /* ABKZ */
	RTL_OTTO_BOARD("GS1920-24-v2",   "Zyxel GS1920-24v2",   MID(27394), 32, 0x200000), /* ABMH */
	RTL_OTTO_BOARD("GS1920-24HP-v2", "Zyxel GS1920-24HPv2", MID(27650), 32, 0x200000), /* ABMI */
	RTL_OTTO_BOARD("GS1920-48-v2",   "Zyxel GS1920-48v2",   MID(27906), 32, 0x200000), /* ABMJ */
	RTL_OTTO_BOARD("GS1920-48HP-v2", "Zyxel GS1920-48HPv2", MID(28162), 32, 0x200000), /* ABMK */
	RTL_OTTO_BOARD("GS2210-8",       "Zyxel GS2210-8",      MID(21506), 32, 0xB0000),  /* AASP */
	RTL_OTTO_BOARD("GS2210-8HP",     "Zyxel GS2210-8HP",    MID(21762), 32, 0xB0000),  /* AASQ */
	RTL_OTTO_BOARD("GS2210-24",      "Zyxel GS2210-24",     MID(19458), 32, 0xB0000),  /* AAND */
	RTL_OTTO_BOARD("GS2210-24HP",    "Zyxel GS2210-24HP",   MID(19714), 32, 0xB0000),  /* AANE */
	RTL_OTTO_BOARD("GS2210-24LP",    "Zyxel GS2210-24LP",   MID(24322), 32, 0xB0000),  /* ABEO */
	RTL_OTTO_BOARD("GS2210-48",      "Zyxel GS2210-48",     MID(18946), 32, 0xB0000),  /* AAHV */
	RTL_OTTO_BOARD("GS2210-48HP",    "Zyxel GS2210-48HP",   MID(19202), 32, 0xB0000),  /* AAHW */
	...
	RTL_OTTO_BOARD("XGS2220-30",     "Zyxel XGS2220-30",    MID(34306), 64, 0x280000), /* ABXN */
	RTL_OTTO_BOARD("XGS2220-30HP",   "Zyxel XGS2220-30HP",  MID(34562), 64, 0x280000), /* ABXO */
	RTL_OTTO_BOARD("XGS2220-30F",    "Zyxel XGS2220-30F",   MID(34818), 64, 0x280000), /* ABYE */
	RTL_OTTO_BOARD("XGS2220-54",     "Zyxel XGS2220-54",    MID(35074), 64, 0x280000), /* ABXP */
	RTL_OTTO_BOARD("XGS2220-54HP",   "Zyxel XGS2220-54HP",  MID(35330), 64, 0x280000), /* ABXQ */
	RTL_OTTO_BOARD("XGS2220-54FP",   "Zyxel XGS2220-54FP",  MID(35586), 64, 0x280000), /* ACCE */
