...
static struct device_info boards[] = {
	...
	/** Firmware layout for the CPE710 V2 */
	{
		.id     = "CPE710V2",
		.vendor = "CPE710(TP-LINK|UN|AC866-5|00000000):2.0\r\n",
		.support_list =
			"SupportList:\r\n"
  ...
  /** Firmware layout for the RE200 v4 */
	...
	/** Firmware layout for the RE205 v2 */
	{
		.id     = "RE205-V2",
		.vendor = "",
		.support_list =
			"SupportList:\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:00000000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:45550000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:4A500000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:4B520000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:43410000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:41550000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:42520000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:55530000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:41520000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:52550000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:54570000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:45530000}\n"
			"{product_name:RE205,product_ver:2.0.0,special_id:45470000}\n",
		.part_trail = 0x00,
		.soft_ver = SOFT_VER_TEXT("soft_ver:1.1.0\n"),
